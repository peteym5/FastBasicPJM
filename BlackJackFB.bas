...
PROC INIT_GAME
     ...
     '   FOR N=0 TO 29
     '     POKE @SCREEN_ADDR+04+N,CARDSHOW1(N)
     '     POKE @SCREEN_ADDR+44+N,CARDSHOW2(N)
     '     POKE @SCREEN_ADDR+84+N,CARDSHOW3(N)
     '     POKE @SCREEN_ADDR+204+N,CARDSHOW4(N)
     '     POKE @SCREEN_ADDR+244+N,CARDSHOW5(N)
     '     POKE @SCREEN_ADDR+284+N,CARDSHOW6(N)
     '     POKE @SCREEN_ADDR+440+N,64+N
     '     POKE @SCREEN_ADDR+480+N,192+N
     '     POKE @SCREEN_ADDR+640+N,64+N
     '     POKE @SCREEN_ADDR+680+N,192+N
     '     POKE @SCREEN_ADDR+840+N,64+N
     '     POKE @SCREEN_ADDR+880+N,192+N
     '   NEXT N
